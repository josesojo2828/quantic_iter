               ...
               {dailyTasks.length === 0 ? (
                  ...
                  <div className="space-y-3">
                     {dailyTasks.map((task) => {
                        const isCompleted = isTaskCompletedToday(task);
                        return (
                           <div key={task.id} className={`glass-card p-4.5 rounded-[20px] border transition-all duration-500 flex items-center justify-between group ${isCompleted
                              ...
                              <div className="flex items-center gap-4">
                                 <button
                                    ...
                                    className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all ${isCompleted
